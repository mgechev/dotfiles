#!/bin/bash
# move-right.sh: Move the active window to the right half of the screen.
...
# Calculate new dimensions and position for RIGHT half of the entire screen
NEW_WIDTH=$((SCREEN_W / 2))
NEW_HEIGHT=$SCREEN_H
NEW_X=$((SCREEN_W / 2))
NEW_Y=0
